...
/*public class Blackjack extends Application {
    ...
    private Image card = new Image("file:src/main/resources/cards/2p.png");
    private Image card2 = new Image("file:src/main/resources/cards/D-Ki.png");
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        //control
        Button bt1 = new Button("Przycisk");
        bt1.setText("Podglad");
        ...
        cards.getChildren().add(bt1);
        cards.setHgap(25);

        grid.add(cards, 5, 5, 3, 5);
